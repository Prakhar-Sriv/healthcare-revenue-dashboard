...
predictions.to_csv("data/denial_model_predictions.csv", index=False)
...
metrics.to_csv("data/denial_model_metrics.csv", index=False)
...
importance.to_csv("data/denial_feature_importance.csv", index=False)
